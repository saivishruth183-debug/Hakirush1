...
export default function Gallery() {
  ...
  <section className="pt-24 pb-20 relative">
    ...
    <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
      ...
      >
        <h1 className="text-5xl lg:text-6xl font-extrabold mb-6 text-white drop-shadow-[0_2px_10px_rgba(255,255,255,0.1)]">
  ...
  {/* Gallery Section */}
  <section className="py-20 bg-gradient-to-t from-white via-gray-100 to-neutral-200 relative overflow-hidden">
          ...
          <button
            ...
            className={`px-6 py-3 rounded-full font-semibold transition-all duration-300 ${
              selectedCategory === category
                ? 'bg-red-600 text-white shadow-lg shadow-red-300/30 scale-105'
                : 'bg-white text-gray-800 border border-gray-300 hover:border-red-400 hover:text-red-600 hover:shadow-md hover:scale-105'
            }`}
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 perspective-1000">
        {filteredItems.map((item, index) => (
          <motion.div
            ...
            className="relative bg-white rounded-2xl shadow-lg overflow-hidden cursor-pointer hover:shadow-2xl hover:shadow-red-200 transform-gpu border border-gray-200"
          ...
          >
            ...
            />
            <div className="px-4 py-4 bg-gradient-to-r from-white via-gray-50 to-white">
    ...
    {lightboxOpen && (
      ...
      >
        ...
        >
          ...
          <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-white text-center bg-black/40 backdrop-blur-md px-7 py-2 rounded-lg">
